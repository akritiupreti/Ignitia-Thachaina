...
def run(name):
    ...
    for char in characters:
        if char.islower():
            alphabet_images[char + "_lower"] = Image.open("OCR_and_Generator/Characters/" + char + "_lower.jpg")
        else:
            alphabet_images[char] = Image.open("OCR_and_Generator/Characters/" + char + ".jpg")

    alphabet_images[" "] = Image.open("OCR_and_Generator/Characters/space.jpg")
